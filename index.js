  ...
  // var win = function() {
  //   if ((earth.byWho === 'xyphonoid') && (uranus.byWho === 'xyphonoid') && (
  //       mars.byWho === 'xyphonoid') ||
  //     (earth.byWho === 'xyphonoid') && (neptune.byWho === 'xyphonoid') && (
  //       mercury.byWho === 'xyphonoid') ||
  //     (neptune.byWho === 'xyphonoid') && (theSun.byWho === 'xyphonoid') && (
  //       venus.byWho === 'xyphonoid') ||
  //     (mars.byWho === 'xyphonoid') && (venus.byWho === 'xyphonoid') && (
  //       jupiter
  //       .byWho === 'xyphonoid') ||
  //     (uranus.byWho === 'xyphonoid') && (theSun.byWho === 'xyphonoid') && (
  //       saturn.byWho === 'xyphonoid') ||
  //     (mars.byWho === 'xyphonoid') && (theSun.byWho === 'xyphonoid') && (
  //       mercury.byWho === 'xyphonoid') ||
  //     (mercury.byWho === 'xyphonoid') && (saturn.byWho === 'xyphonoid') && (
  //       jupiter.byWho === 'xyphonoid') ||
  //     (jupiter.byWho === 'xyphonoid') && (theSun.byWho === 'xyphonoid') && (
  ...
  //
  //   } else if ((earth.byWho === 'ovaria') && (uranus.byWho === 'ovaria') && (
  //       mars.byWho === 'ovaria') ||
  //     (earth.byWho === 'ovaria') && (neptune.byWho === 'ovaria') && (mercury.byWho ===
  //       'ovaria') ||
  //     (neptune.byWho === 'ovaria') && (theSun.byWho === 'ovaria') && (venus.byWho ===
  //       'ovaria') ||
  //     (mars.byWho === 'ovaria') && (venus.byWho === 'ovaria') && (jupiter.byWho ===
  //       'ovaria') ||
  //     (uranus.byWho === 'ovaria') && (theSun.byWho === 'ovaria') && (saturn.byWho ===
  //       'ovaria') ||
  //     (mars.byWho === 'ovaria') && (theSun.byWho === 'ovaria') && (mercury.byWho ===
  //       'ovaria') ||
  //     (mercury.byWho === 'ovaria') && (saturn.byWho === 'ovaria') && (jupiter
  //       .byWho ===
  //       'ovaria') ||
  //     (jupiter.byWho === 'ovaria') && (theSun.byWho === 'ovaria') && (earth.byWho ===
  //       'ovaria')) {
  //
  //     alert(
  ...
  // console.log(oTurn);
  // $(function() {
  //   // if((xTurn === 'true' && oTurn === 'false') || (xTurn === 'false' && oTurn === 'true')){
  //
  ...
  //           "draggableO") && (earth.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/0cBHUU3.png');
  ...
  //           "draggableO") && (uranus.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //         changeText("Uranus has been saved by the Ovarias!")
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/xcqk7Km.png');
  //         uranus.byWho = 'ovaria'
  ...
  //           "draggableO") && (mars.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/4iLcaae.png');
  ...
  //           "draggableO") && (neptune.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/SS0IRXq.png');
  ...
  //           "draggableO") && (theSun.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/pekTKHw.png');
  ...
  //           "draggableO") && (venus.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/EWbippL.png');
  ...
  //           "draggableO") && (mercury.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/CPntIMv.png');
  ...
  //           "draggableO") && (saturn.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/cLeNrxm.png');
  ...
  //           "draggableO") && (jupiter.controlled === false) && (oTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/Vi0m3On.png');
  ...
  //           "draggableX") && (earth.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/toCSozd.gif');
  ...
  //         oTurn = true;
  //       } else if (current_square === 'c2' && ui.draggable.hasClass(
  //           "draggableX") && (uranus.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/toCSozd.gif)');
  ...
  //         oTurn = true;
  //       } else if (current_square === 'c3' && ui.draggable.hasClass(
  //           "draggableX") && (mars.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/toCSozd.gif)');
  ...
  //         oTurn = true;
  //       } else if (current_square === 'c4' && ui.draggable.hasClass(
  //           "draggableX") && (neptune.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/toCSozd.gif)');
  ...
  //         oTurn = true;
  //       } else if (current_square === 'c5' && ui.draggable.hasClass(
  //           "draggableX") && (theSun.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/fPobuiJ.png)');
  ...
  //         oTurn = true;
  //       } else if (current_square === 'c6' && ui.draggable.hasClass(
  //           "draggableX") && (venus.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/toCSozd.gif)');
  ...
  //         oTurn = true;
  //       } else if (current_square === 'c7' && ui.draggable.hasClass(
  //           "draggableX") && (mercury.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/toCSozd.gif)');
  ...
  //         oTurn = true;
  //       } else if (current_square === 'c8' && ui.draggable.hasClass(
  //           "draggableX") && (saturn.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/toCSozd.gif)');
  ...
  //         oTurn = true;
  //       } else if (current_square === 'c9' && ui.draggable.hasClass(
  //           "draggableX") && (jupiter.controlled === false) && (xTurn ===
  //           true)) {
  //         reset_text();
  //         $(this).css('background-image',
  //           'url(http://i.imgur.com/toCSozd.gif)');
